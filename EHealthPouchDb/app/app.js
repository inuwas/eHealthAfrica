(function() {
  ...
  var remoteCouch = 'http://127.0.0.1:5984/todosync';
  ...
  function shehuTodos(){
	...
	db.allDocs({include_docs: true}).then(function(resultOfAllDocs){
		return Promise.all(resultOfAllDocs.rows.map(function(row){
			return row.doc;
		}));
	}).then(function(arrayOfResults){
		var doc = arrayOfResults;
